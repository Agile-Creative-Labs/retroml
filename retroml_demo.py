...
Single Customer Analysis: Input individual customer data and get instant churn predictions
Batch Processing: Analyze multiple customers at once
Interactive Mode: Real-time question-and-answer interface
Rich Visualizations: Tables, colored output, and detailed confidence scores
Model Insights: Feature importance and performance metrics

How to Use:

First, ensure you have a trained model:
bashpython retroml.py configs/classification_example.json
...
High-risk customer: Young, short tenure, month-to-month contract, high charges
Low-risk customer: Older, long tenure, long-term contract, moderate charges
Batch analysis: Multiple customer profiles processed simultaneously
Real-time interaction: Live prediction interface

The demos showcase the model's practical utility while maintaining 
the fun, nostalgic RetroML aesthetic. They're production-ready and can be easily integrated into real business applications!


RetroML Churn Prediction Demo  
=================================  
Binary classification demo predicting customer churn (leave/stay) using:  
- Sample telecom customer data  
- Features: contract type, monthly charges, tenure, etc.  
- Output: Probability of churn + confidence scores  
